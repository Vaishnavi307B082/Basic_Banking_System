...
<div class="container">
    <h2 class="text-center pt-4" style="color : rgb(11, 139, 161)"><b>View User</b></h2>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="view.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style=" background-color : rgb(11, 139, 161);">View</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
